...
public class EcommercePlatform{
    public static void main(String[] args){
        // Creating products
        Product laptop = new Product("Smartphone", 10000.0);
        Product phone = new Product("Laptop", 60000.0);
        Product headphones = new Product("Headphones", 5500.0);

        // Creating customers
        Customer customer1 = new Customer("Abhishek");
        Customer customer2 = new Customer("Sagar");
