...
public class StudentRecord {
    public static void main(String[] args) {
        ...
        list.addStudentAtEnd(101, "Abhishek", 21, 'A');
        list.addStudentAtEnd(102, "Priyanshu", 21, 'B');
        list.addStudentAtBeginning(103, "Dynast", 21, 'A');
        list.addStudentAtPosition(2, 104, "Abhi", 21, 'B');
