...
public class InsuranceSystem {
  public static void main(String[] args) {
    ...
    Policy p1 = new Policy("P123", "Abhishek", exp1, "Health", 5000.0);
    Policy p2 = new Policy("P124", "Priyanshu", exp2, "Auto", 1700.0);
    Policy p3 = new Policy("P125", "Abhi", exp1, "Home", 2900.0);
